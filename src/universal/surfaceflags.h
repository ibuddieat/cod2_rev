...
#define MASK_ALL                   ( -1 )
#define MASK_SOLID                 ( CONTENTS_SOLID | CONTENTS_GLASS | CONTENTS_SKY )
#define MASK_PLAYERSOLID           ( CONTENTS_SOLID | CONTENTS_GLASS | CONTENTS_PLAYERCLIP | CONTENTS_UNKNOWN | CONTENTS_BODY )

#define MASK_SHOT                  ( CONTENTS_SOLID | CONTENTS_GLASS | CONTENTS_WATER | CONTENTS_SKY | CONTENTS_CLIPSHOT | CONTENTS_UNKNOWN | CONTENTS_BODY )
